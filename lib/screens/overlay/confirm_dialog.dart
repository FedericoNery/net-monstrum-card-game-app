...
import 'package:net_monstrum_card_game/screens/overlay/confirm_dialog_widget.dart';

class ConfirmDialogComponentOverlay extends FlameGame
{
  final BattleCardGame battleCardGame;

  ConfirmDialogComponentOverlay(this.battleCardGame)
      : super(
