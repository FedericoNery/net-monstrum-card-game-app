...
class TextsCounters {
    ...
    TextsCounters(){
      ...
      position: Vector2(CountersMeasures.BLUE_RIVAL_X + offsetNumbersXRival, CountersMeasures.BLUE_RIVAL_Y + offsetNumbersYRival),
      );

    redCounterTextRival = TextComponent(
      text: '${0}',
      size: Vector2.all(10.0),
      position: Vector2(CountersMeasures.RED_RIVAL_X + offsetNumbersXRival, CountersMeasures.RED_RIVAL_Y + offsetNumbersYRival),
    );
 ...
 */    
    brownCounterTextRival = TextComponent(
      text: '${0}',
      size: Vector2.all(10.0),
      position: Vector2(CountersMeasures.BROWN_RIVAL_X + offsetNumbersXRival, CountersMeasures.BROWN_RIVAL_Y + offsetNumbersYRival),
    );

    whiteCounterTextRival = TextComponent(
      text: '${0}',
      size: Vector2.all(10.0),
      position: Vector2(CountersMeasures.WHITE_RIVAL_X + offsetNumbersXRival, CountersMeasures.WHITE_RIVAL_Y + offsetNumbersYRival),
    );
    blackCounterTextRival = TextComponent(
      text: '${0}',
      size: Vector2.all(10.0),
      position: Vector2(CountersMeasures.BLACK_RIVAL_X + offsetNumbersXRival, CountersMeasures.BLACK_RIVAL_Y + offsetNumbersYRival),
    );
    greenCounterTextRival = TextComponent(
      text: '${0}',
      size: Vector2.all(10.0),
      position: Vector2(CountersMeasures.GREEN_RIVAL_X + offsetNumbersXRival, CountersMeasures.GREEN_RIVAL_Y + offsetNumbersYRival),
    );
